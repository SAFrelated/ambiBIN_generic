...
#ifndef ambiBIN_genericFX_H
#define ambiBIN_genericFX_H
...
private:
    ambiBIN_genericFXParams* m_pParams;
    AK::IAkPluginMemAlloc* m_pAllocator;
    AK::IAkEffectPluginContext* m_pContext;

	void* hAmbi;				// ambi_bin handle. Spatial Audio Framework SAF uses this for handling parameters
};

#endif // ambiBIN_genericFX_H
